window.hjSiteSettings = window.hjSiteSettings || {
    ...
    "features": ["client_script.safe_date", "feedback.widgetV2", "feedback.widget_telemetry", "heatmap.continuous_capture", "recordings.page_content_ws", "settings.billing_v2", "survey.impressions"]
};
...
! function(e) {
    ...
    339: function(e, t) {
        window.hjBootstrap = window.hjBootstrap || function(e, t, n) {
            ...
            if (a.test(r)) console.warn("Hotjar not launching due to suspicious userAgent:", r);
                ...
                if (!s || d) {
                    ...
                    }, l.varsJar = c, "interactive" === h.readyState || "complete" === h.readyState || "loaded" === h.readyState ? f() : h.addEventListener("DOMContentLoaded", f), l.revision = "b0148c0b8426", window.hjBootstrap = l)
        ...
        }, window.hjBootstrap("https://script.hotjar.com/", "modules.6d6d0fb9462e12691e7f.js", "1368889"), window.hjLazyModules = window.hjLazyModules || {
            SURVEY_V2: {
                js: "survey-v2.c1e876fbc81b32165ebf.js"
            },
            SURVEY_BOOTSTRAPPER: {
